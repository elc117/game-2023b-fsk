...
public class Obstaculo {
    ...
    public Obstaculo() {
        ...
        retanguloOssoInferior = new Rectangle(Gdx.graphics.getWidth() + 60, paredeY - 335, 66, 340);
        retanguloOssoSuperior = new Rectangle(Gdx.graphics.getWidth() + 60, paredeY + areaLivre, 68, 340);
