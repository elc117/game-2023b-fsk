...
public class GameOver implements Screen {
    ...
    private TextureRegionDrawable labelAddLeaderboard;

    private ImageButton addLeaderboard;




    public GameOver(MyGdxGame jogo) {
        ...
        labelAddLeaderboard = new TextureRegionDrawable(new Texture("MenuPrincipal/LabelAddLeaderboard.png"));
    }
